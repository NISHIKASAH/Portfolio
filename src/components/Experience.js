    ...
    <div className="py-10 bg-[#22325]" id="experience">
     ...
     <div className="mb-[20px] text-white relative bg-gray-700/20 p-4 rounded-3xl max-w-[300px] sm:max-w-[600px] mx-auto pb-16">
        ...
        <p className="text-gray-500">
         Developed key features including signup with captch, secure authentication, and login workflows using net mvc
     ...
     <div className="mb-[20px] text-white relative bg-gray-700/20 p-4 rounded-3xl max-w-[300px] sm:max-w-[600px] mx-auto pb-16"">
        ...
        <p className="text-gray-500">
             Developed and optimized UI components in a live SaaS product using Reactjs, TypeScript, and JavaScript
             Built new features, enhanced performance, and fixed UI bugs for a seamless user experience
             Contributed to backend tasks using Nodejs, Expressjs , and mongodb
